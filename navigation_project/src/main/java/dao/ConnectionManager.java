...
public class ConnectionManager
{
	...
	public static Connection getConnection()
	{
		...
		try
		{
			...
			{
				System.out
						.println("\u001B[1m_________________Error In Connecting Winkdoc Database__________________\u001B[0m");
				ex.printStackTrace();
			}
		}
		...
		{
			System.out
					.println("\u001B[1m_________________Re-Connecting With Winkdoc Database__________________\u001B[0m");
		...
		{
			System.out
					.println("\u001B[1m_________________Something Went Wrong Re-Connecting With Winkdoc Database__________________\u001B[0m");
			ConnectionManager.getConn();
			e.printStackTrace();
		}
